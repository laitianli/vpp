...
extern udp_fwd_main_t udp_fwd_main;

extern int udp_fwd_ul_xmit(u8* buf, u32 data_len, dgram_hdr_t *dhdr);
extern int udp_fwd_ul_init(vlib_main_t* vm);
extern void udp_fwd_ul_uninit(vlib_main_t* vm);

extern const char* open_close_udp_fwd_pcap(const char *pathname, u8 is_open, int cpuid);
extern void udp_fwd_ul_pcap(u8* data, u32 len, u8 is_ip4);
extern void udp_fwd_dl_pcap(u8* data, u32 len, u8 is_ip4);
